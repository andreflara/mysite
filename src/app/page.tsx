...
const CustomLink = ({ href, label, icon, external = false, className = "" }) => {
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-900 to-black p-6 text-white md:p-12">
      <div className="container px-4 py-8">
        ...
        <section className="mb-8">
          ...
          <div className="mb-4">
            <CustomLink
              href="https://group-links.vercel.app/"
              label="SearchHub"
              external
              icon={
                <Search/>
        ...
        <footer className="border-t border-gray-800 pt-6">
          <div className="flex justify-center space-x-6">
            <SocialIcon href="https://github.com/oandrezito" title="Github">
              <svg className="h-8 w-8" viewBox="0 0 24 24" fill="currentColor" title="YouTube Icon">
            ...
            <SocialIcon href="https://linkedin.com/in/andrefernando" title="LinkedIn">
